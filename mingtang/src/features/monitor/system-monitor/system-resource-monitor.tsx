/**
 * SystemResourceMonitor 系统资源监控子组件（T1-6-9 搬移——cockpit 只读模式）
 *
 * 定位：system-monitor 聚合页 system Tab（REST + ws——零写操作）
 * 数据流：useSystemResources（getSystemResources + ws system_resources）

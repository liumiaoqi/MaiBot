...
import { EmotionLandscape } from './emotion-landscape'
import { RelationshipNetwork } from './relationship-network'
import { MemoryGarden } from './memory-garden'
import { LifeTimeline } from './life-timeline'
import { ActiveSessions } from './active-sessions'
import { LifeDefensePanel } from './life-defense-panel'
import { CollapsedParameters } from './collapsed-parameters'
import { UnbindConfirmDialog } from './unbind-confirm-dialog'
import { BindSessionDialog } from './bind-session-dialog'
import { MonologuePanel } from './monologue-panel'
import { AutonomyLogPanel } from '../autonomy-log-panel'
import { StateAwarenessPanel } from '../state-awareness-panel'
...
export function InnerWorldView({ agentId, onBack }: InnerWorldViewProps) {
  ...
  const unbindMutation = useMutation({
    ...
    onError: () => {
      toast.error(t('agent.activeSessions.unbindFailed'))
    },
  })
  ...
  const bindMutation = useMutation({
    ...
    onError: () => {
      toast.error(t('agent.activeSessions.bindFailed'))
    },
  })

 ...
 *
 * set-state-in-effect：effect 内 setState 用 requestAnimationFrame 包裹，
 * 避免 React 19 警告（与 R4-2 hooks 一致）。
 */
...
export function MemoryDeleteDialog({
  ...
  // set-state-in-effect：用 requestAnimationFrame 包裹 setState，避免 React 19 警告
  useEffect(() => {

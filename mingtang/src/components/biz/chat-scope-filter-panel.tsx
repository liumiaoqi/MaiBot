/**
 * ChatScopeFilterPanel 聊天范围筛选侧边栏（R4-1-2-2）
 *
 * 从 dashboard 行为等价搬移——适配导入路径（StreamlineIcon → ChevronRight 直接使用）
 * 主题适配：文字显式 text-foreground / text-muted-foreground（ADR-5 零黑字）
 *
 * design.md §3.8.3
 */

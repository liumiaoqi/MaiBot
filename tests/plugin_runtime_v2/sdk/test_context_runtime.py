...
class TestLoggerContext:
    ...
    def test_info_bridges_to_logger(self) -> None:
        with patch("src.common.logger.get_logger") as mock_get:
...
class TestEmitEvent:
    ...
    @pytest.mark.asyncio
    async def test_emit_event_calls_runner(self):
        runner = AsyncMock()
    ...
    @pytest.mark.asyncio
    async def test_emit_event_runner_not_ready_raises(self):
        runner = AsyncMock()
...
class TestEmitCard:
    ...
    @pytest.mark.asyncio
    async def test_emit_card_constructs_payload(self):
        runner = AsyncMock()
        runner.is_ready = True
    ...
    @pytest.mark.asyncio
    async def test_emit_card_unregistered_logs_warning(self):
        runner = AsyncMock()
        runner.is_ready = True
        ctx = PluginContext("p", set(), runner, {})
...
class TestGetSessionInfo:
    ...
    @pytest.mark.asyncio
    async def test_get_session_info_denied_without_scope(self):

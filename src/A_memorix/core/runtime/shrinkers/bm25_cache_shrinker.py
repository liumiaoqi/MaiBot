"""ZG-28 Bm25Cache shrinker（ZG-27 Shrinker Protocol 衔接）。

count=超 TTL 条数，scan=pop 过期，seeks=1，priority_score=700。
"""
...
class Bm25CacheShrinker:
    """Bm25Cache TTL 过期 shrinker。"""
    ...
    def __init__(self, bm25_cache) -> None:
        self._cache = bm25_cache

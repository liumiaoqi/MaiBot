...
AMEMORIX_ADVANCED_FIELD_PATHS: set[str] = {
    ...
    "a_memorix.memory.enable_watermark_reclaim",
    "a_memorix.memory.shrinker.batch_size",
    "a_memorix.memory.shrinker.def_priority",
    "a_memorix.memory.watermark.check_interval_sec",
    "a_memorix.memory.watermark.high",
    "a_memorix.memory.watermark.low",
    "a_memorix.memory.watermark.min",
    "a_memorix.memory_fusion.score_alpha",
    "a_memorix.memory_fusion.spread_depth",
    "a_memorix.memory_fusion.stage",
    "a_memorix.memory_fusion.write_lock_timeout",
    ...
    "a_memorix.retrieval.cache.bm25_cache_max_entries",
    "a_memorix.retrieval.cache.bm25_cache_ttl_seconds",
    "a_memorix.retrieval.cache.embedding_cache_max_entries",
    "a_memorix.retrieval.cache.embedding_cache_ttl_seconds",
    "a_memorix.retrieval.cache.enable_bm25_cache",
    "a_memorix.retrieval.cache.enable_embedding_cache",
    "a_memorix.retrieval.cache.enable_node_cache",
    "a_memorix.retrieval.cache.enable_profile_cache",
    "a_memorix.retrieval.cache.node_cache_ttl_seconds",
    "a_memorix.retrieval.cache.profile_cache_max_entries",
    "a_memorix.retrieval.cache.profile_cache_ttl_seconds",
...
AMEMORIX_EXCLUDED_FIELD_PATHS: set[str] = {
    ...
    "a_memorix.connectionist.enabled",
    "a_memorix.connectionist.inner_voices",
    "a_memorix.connectionist.personality",
    "a_memorix.connectionist.phase",

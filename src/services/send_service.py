...
# 向后兼容别名 — 外部已迁移到 src.core.message_utils
_build_binary_component_from_base64 = build_binary_component_from_base64
_build_message_sequence_from_custom_message = build_message_sequence_from_custom_message
